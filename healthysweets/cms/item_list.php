...
//1.  DB接続します
try {
  $pdo = new PDO('mysql:dbname=hibo_healthy_sweets;charset=utf8;host=mysql57.hibo.sakura.ne.jp','hibo','popo3210');
...
if($status==false) {
 ...
 while( $res = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    $view .= '<p class="cart-thumb"><img src="../img/'.$res["fname"].'" width="200">
    </p>';
